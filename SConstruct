...
for rc_asset_file in rc_asset_files:
    print " -", rc_asset_file
built_source_files.append(env.QtResources('src/newprj/qt_assets_rc.py', ['src/newprj/qt_assets.qrc', ] + rc_asset_files))
...
for py_file in py_files:
    print ' -', py_file
env.Exe('dist/New Project Wizard.exe', py_files)
